...
const roomTypeRoutes = require("./modules/roomType/roomType.routes");
const roomPricingRoutes = require("./modules/roomPricing/roomPricing.routes");
...
router.use("/room-prices", roomPricingRoutes);
